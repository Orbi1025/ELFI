(self["webpackChunk_canva_web"] = self["webpackChunk_canva_web"] || []).push([
  [86064],
  {
    /***/ 293444: function (_, __, __webpack_require__) {
      ...
      (function (__c) {
        var Tbc;
        __c.j1 = function (a, b, c) {
          return new __c.sb(a, c ? __c.ub(c) : void 0, __c.Jaa, {
            ignoreTag: !0,
          }).format(Object.fromEntries(Object.entries(b)));
        };
        __c.Sbc = function (a, b) {
          __c.u(!0);
          __c.u(!0);
          __c.u(!0);
          const { la: c, a: d, b: e } = __c.ws(a),
            { la: f, a: g, b: h } = __c.ws(b);
          a = (c + f) / 2;
          ...
          var k = d * (1 + b),
            ...
            n = Math.hypot(l, h);
          b = (m + n) / 2;
          var p = __c.Js((Math.atan2(e, k) * 180) / Math.PI);
          const q = __c.Js((Math.atan2(h, l) * 180) / Math.PI);
